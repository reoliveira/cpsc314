...
loadOBJ(Part.ANISOTROPIC, 'obj/car.obj', anisotropicMaterial, 0.05, -3.25,0,-4.25, -Math.PI/2,0,0.5);
loadOBJ(Part.ANISOTROPIC, 'obj/male.obj', anisotropicMaterial, 0.015, -0.5,0,-4.5, 0,0,0);
...
loadOBJ(Part.TOON, 'obj/car.obj', toonMaterial, 0.05, -3.25,0,-4.25, -Math.PI/2,0,0.5);
loadOBJ(Part.TOON, 'obj/male.obj', toonMaterial, 0.015, -0.5,0,-4.5, 0,0,0);
...
loadOBJ(Part.GOOCH, 'obj/car.obj', goochMaterial, 0.05, -3.25,0,-4.25, -Math.PI/2,0,0.5);
loadOBJ(Part.GOOCH, 'obj/male.obj', goochMaterial, 0.015, -0.5,0,-4.5, 0,0,0);
gooch.sphere = new THREE.SphereGeometry(1, 16, 16);
gooch.npr_toon = new THREE.Mesh(gooch.sphere, goochMaterial);
gooch.npr_toon.position.set(0, 1, 1);
scenes[Part.GOOCH].add(gooch.npr_toon);
